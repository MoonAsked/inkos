...
const endpointIdsByGroup = {
  overseas: ["anthropic", "google", "mistral", "nvidia", "openai", "xai"],
  china: [
  ...
  aggregator: ["giteeai", "infiniai", "modelscope", "newapi", "opencode", "openrouter", "ppio", "qiniu", "siliconcloud"],
